    ...
    async function saveToDatabase() {
        try {
            ...
            if (response.ok) {
                ...
                // Additional logic after saving to the database
            } else {
        ...
        <div>
            ...
            <div className='flex flex-row justify-center space-x-32 mb-16'>
                <div className='flex justify-center '>
                    <button onClick={saveToDatabase} className='bg-blue-500 hover:bg-blue-600 text-white text-xl px-8 py-2 rounded-xl font-bold'>Save Your Resume Now</button>
                </div>
                <div className='flex justify-center '>
